...
int main()
{
    ...
    try
    {
        ...
        // Shader programs
        auto objectShaderProgram{CShaderProgram::Build("08-objectshader.vert", "08-objectshader.frag")};
        ...
        CTexture emissionMap;
        emissionMap.GenerateTexture("matrix.jpg");
        emissionMap.SetTextureUnitIndex(2);
        objectShaderProgram.SetUniform("material.emission", 2);
