...
public:
    ...
    constexpr CCamera(double aSensitivity, double aMovementSpeedFactor, double aAspectRatio) noexcept
        : _sensitivity{aSensitivity}, _movementSpeedFactor{aMovementSpeedFactor}, _aspectRatio{aAspectRatio},
